...
class Semaforo(Node):
    ...
    def image_callback(self, msg):
        ...
        # Rango corregido para verde detectado en consola
        ...
        # 🔴 Detectar rojo (por separado, sin elif)
        if contours_red:
        ...
        if contours_green:
            ...
            self.get_logger().info(f'🟢 Contorno verde detectado | Área: {area:.2f}')

            if not self.mission_started and area > 300:
